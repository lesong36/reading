...
6. 额外输出文章级 glossary 数组，但只识别专业术语、难词/偏词和外来词，不做“阅读重点词”或逐词翻译。判断难度时以正在阅读本文的中国学生为准，而不是只看词在英语母语者眼中是否罕见：
   - 专业术语、学科概念、行业用语、必要缩写，或具有特定语境义的术语。
   - 对目标读者有实际学习价值、明显超出其日常基础词汇的难词/偏词、主题词汇、罕见词形或不常见词义。
   - 源自其他语言、保留外来语形式或需要文化/语源背景才能理解的外来词。
   不限制数量；只要满足标准就收录，并按重要性排序。必须排除仅仅因为是文章标题、核心概念、关键动作、题目答案或阅读提示而被选中的普通词，以及一般人名地名、普通高频词和按字面即可理解的常见搭配。词条若本身独立符合“专业、难词/偏词、外来词”标准，即使也是主题词或题目答案，仍然必须保留。输出前逐条自检：目标学生是否可能因不认识该词而读不懂句子，或者是否需要专业/文化背景才能准确理解？是则保留；否则删除。不要为了绕过规则把普通词改标成其他 kind。translation 只给出最符合本文语境的简洁中文释义；note 仅在术语语境、外来语背景或罕见义确有必要时填写。
